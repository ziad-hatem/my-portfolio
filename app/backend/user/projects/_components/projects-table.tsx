...
export const columns: ColumnDef<Projects>[] = [
  {
    ...
    cell: ({ row }) => {
      ...
      return <div>{id.substring(20) + "..."}</div>;
    },
  },
  {
    accessorKey: "title",
      ...
      return (
        <div className="font-medium">
          <Link target="_blank" href={row.getValue("linkedinUrl")}>
            <Button variant={"link"}>Linkedin Url</Button>
          </Link>
        </div>
      );
    },
      ...
      return (
        <div className="font-medium">
          <Link target="_blank" href={row.getValue("githubUrl")}>
            <Button variant={"link"}>Github Url</Button>
          </Link>
        </div>
      );
    },
  },
  {
    ...
    cell: ({ row }) => {
      ...
      const arr = Array.from(technologies);
      return (
        <div className="font-medium">
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      const handleDelete = async () => {
        ...
        try {
          await axios.delete(
            `/api/user/project?email=${userData.email}&id=${id}`
          );
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end">
            ...
            <DropdownMenuItem
              onClick={() =>
                router.push(
                  `/backend/user/projects/edit?projectId=${row.getValue("id")}`
                )
              }
            >
              Edit Project
...
export function TableProjects({ data }: { data: Projects[] }) {
    ...
    <div className="w-full">
      <div className="flex items-center py-4 gap-2">
        ...
        <Button
          variant={"secondary"}
          onClick={() => {
            router.push("/backend/user/projects/create");
          }}
        >
          Create Project
        </Button>
